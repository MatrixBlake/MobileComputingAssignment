...
public class PhoneLoginActivity extends AppCompatActivity {
        ...
        VerifyButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(TextUtils.isEmpty(verificationCode)){
                    ...
                    loadingBar.setMessage("Please wait, we are verifying your verification ncode");
                    loadingBar.setCanceledOnTouchOutside(false);
                    loadingBar.show();
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            loadingBar.dismiss();
                            Toast.makeText(PhoneLoginActivity.this, "Congratulations, you log in successfully!", Toast.LENGTH_SHORT).show();
    ...
    private void SendUserToMainActivity() {
        Intent mainIntet =  new Intent(PhoneLoginActivity.this,MainActivity.class);
